    ...
    <div class="clear40"></div>
        ...
        <form method="post" action="{{route('student.update' , [$student->id])}}"  enctype="multipart/form-data">
            ...
            <div class="col-md-6">
               ...
               <!--  <div class="imageupload ">
                    <div class="file-tab ">
                        <img src="{{asset($student['user']->Card_Image)}}" alt="Image preview" class="thumbnail" style="max-width: 250px; max-height: 250px">
                        <label class="btn btn-default btn-file">
                            <span>Card Image</span>
                            <input type="file" name="Card_Image" value="">
                        </label>
            ...
            <div class="submit-btn">
                ...
                <div class="col-md-6">
                    ...
                    <div class="pull-right">
                        <a type="button" href="{{route('student.index')}}" class="btn btn-default btn-wide">Cancel</a>
                    </div>
                </div>
                <div class="col-md-3"></div>
            </div>
