...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}/assets/css/frontierCalendar/jquery-frontier-cal-1.3.2.css" />

    <!-- Include CSS for color picker plugin (Not required for calendar plugin. Used for example.) -->
    <link rel="stylesheet" type="text/css" href="{{asset('')}}/assets/css/colorpicker/colorpicker.css" />

    <!-- Include CSS for JQuery UI (Required for calendar plugin.) -->
    <link rel="stylesheet" type="text/css" href="{{asset('')}}/assets/css/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css" />
    ...
    ** This is our IE fix version which enables drag-and-drop to work correctly in IE. See README file in js/jquery-core folder. **
    -->
    <script type="text/javascript" src="{{asset('')}}/assets/js/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>

    <!-- Include JQuery UI (Required for calendar plugin.) -->
    <script type="text/javascript" src="{{asset('')}}/assets/js/jquery-ui/smoothness/jquery-ui-1.8.1.custom.min.js"></script>

    <!-- Include color picker plugin (Not required for calendar plugin. Used for example.) -->
    <script type="text/javascript" src="{{asset('')}}/assets/js/colorpicker/colorpicker.js"></script>

    <!-- Include jquery tooltip plugin (Not required for calendar plugin. Used for example.) -->
    <script type="text/javascript" src="{{asset('')}}/assets/js/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js"></script>
    ...
    -->
    <script type="text/javascript" src="{{asset('')}}/assets/js/lib/jshashtable-2.1.js"></script>

    <!-- Include JQuery Frontier Calendar plugin -->
    <script type="text/javascript" src="{{asset('')}}/assets/js/frontierCalendar/jquery-frontier-cal-1.3.2.min.js"></script>
            ...
            <nav class="navbar navbar-default bootsnav">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#brand"><img src="{{asset('')}}/assets/images/logo.png" class="logo" alt=""></a>
                    </div>
...
<div>
    ...
    <div id="example" style="margin: auto; width:80%;">
        <h1 style="font-size: 30px; font-weight: bold;">Holiday Calendar</h1>
