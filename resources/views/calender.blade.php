            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $.each(res , function (index, obj) {
                        ...
                        var endDateObj = new Date(parseInt(endDate.format('YYYY')),parseInt(endDate.format('MM'))-1,parseInt(endDate.format('DD')),0,0,0,0);
