...
<h2>Staff Register</h2>
            <table id="example" class="table table-striped table-bordered display" width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>{{ isset($attendance->teacher) ? parse($attendance->teacher->created_at)->format('M'):null}}</td>
                    <td>{{isset($attendance->teacher) ? parse($attendance->teacher->created_at)->format('Y'):null}}</td>
