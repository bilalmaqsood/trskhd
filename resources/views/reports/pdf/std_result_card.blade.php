...
<body>
        <div>
            ...
            <div class="pull-left"><b>Student Name:</b> {{$student->name}}<br> <b>Father Name:</b> <u style="text-align: left">{{$student['user']->Guardian}}</u></div>
            <div class="pull-right">  <img src="{{asset($student['user']->Image)}}" alt="student_image" class="thumbnail" style="width: 100px; height: 110px; object-fit: cover;"></div>
            <div class="clear20"></div>
